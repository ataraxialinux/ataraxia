...
build_rootfs() {
	...
	sleep 1
	for PKG in zlib m4 bison flex libelf binutils gmp mpfr mpc gcc attr acl libcap sed pkgconf ncurses e2fsprogs iana-etc libtool iproute2 perl readline autoconf automake bash bc file gawk grep less kbd make xz kmod expat patch gperf eudev busybox vim gdb libressl openssh curl git libarchive lynx libnl wireless_tools wpa_supplicant linux grub; do

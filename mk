...
generate_initrd() {
	...
	pkginstallinitrd filesystem linux-headers musl zlib attr acl libcap sed ncurses shadow util-linux e2fsprogs readline mksh bash file kbd xz kmod busybox libressl ca-certificates dosfstools eudev linux lzo zstd btrfs-progs nano libnl wpa_supplicant curl lzip

...
generate_initrd() {
	...
	pkginstallinitrd filesystem linux-headers musl zlib attr acl libcap ncurses util-linux procps-ng e2fsprogs coreutils readline bash file kbd xz kmod busybox libressl ca-certificates dosfstools eudev linux nano libnl wpa_supplicant curl wget

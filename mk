...
generate_initrd() {
	...
	pkginstallinitrd filesystem linux-headers musl zlib attr acl libcap ncurses shadow util-linux e2fsprogs coreutils readline bash file kbd xz busybox libressl ca-certificates dosfstools linux libnl wpa_supplicant curl wget

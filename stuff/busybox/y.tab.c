...
{
       0,    80,    80,    81,    82,    83,    86,   110,   114,   120,
     123,   138,   141,   144,   147,   152,   155,   165,   169,   171,
     175,   178,   183,   185
};
#endif
...
{
  "$end", "error", "$undefined", "TPERMIT", "TDENY", "TAS", "TCMD",
  "TARGS", "TNOPASS", "TPERSIST", "TKEEPENV", "TSETENV", "TSTRING",
  "'\\n'", "'{'", "'}'", "$accept", "grammar", "rule", "action", "options",
  "option", "strlist", "ident", "target", "cmd", "args", YY_NULLPTR
};
#endif
...
{
       0,     0,     0,     5,     1,     9,     8,     3,     0,     0,
       7,     4,    17,    18,    11,    12,    13,     0,    10,     0,
      20,    15,    19,     0,     6,     0,    22,    16,    14,    15,
      21,    23
};
...
{
       0,     1,    17,    13,     0,     3,     4,    13,    18,    19,
      20,    13,    12,    23,     8,     9,    10,    11,    21,     5,
      24,    14,    12,     6,    25,    22,    12,    12,    15,     7,
      26,    22
};

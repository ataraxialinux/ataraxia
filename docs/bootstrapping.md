...
dnf install mtools libisoburn python3 pigz libarchive curl jq rsync bsdtar glibc-static freetype-devel zlib-devel xz-devel elfutils-libelf-devel openssl-devel
